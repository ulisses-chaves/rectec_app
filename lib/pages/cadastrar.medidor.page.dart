...
class _CadastrarMedidorPageState extends State<CadastrarMedidorPage> {
  ...
  verificarSenha(BuildContext context) {
    ...
    cadastrarMedidor(context);
    return;
  }

  cadastrarMedidor(BuildContext context) async {
    var bloc = Provider.of<UserBloc>(context);
    var resposta = await bloc.addUsuario(nome, cpf, email, endereco, perfil, profissao, senha);
    Scaffold.of(context).showSnackBar(
      SnackBar(
